package com.example.eye.ui.common.holder
...
import com.example.eye.Const.ItemViewType.Companion.AUTO_PLAY_VIDEO_AD
import com.example.eye.Const.ItemViewType.Companion.BANNER
import com.example.eye.Const.ItemViewType.Companion.BANNER3
import com.example.eye.Const.ItemViewType.Companion.COLUMN_CARD_LIST
import com.example.eye.Const.ItemViewType.Companion.FOLLOW_CARD
import com.example.eye.Const.ItemViewType.Companion.HORIZONTAL_SCROLL_CARD
import com.example.eye.Const.ItemViewType.Companion.INFORMATION_CARD
import com.example.eye.Const.ItemViewType.Companion.SPECIAL_SQUARE_CARD_COLLECTION
import com.example.eye.Const.ItemViewType.Companion.TAG_BRIEFCARD
import com.example.eye.Const.ItemViewType.Companion.TEXT_CARD_FOOTER2
import com.example.eye.Const.ItemViewType.Companion.TEXT_CARD_FOOTER3
import com.example.eye.Const.ItemViewType.Companion.TEXT_CARD_HEADER4
import com.example.eye.Const.ItemViewType.Companion.TEXT_CARD_HEADER5
import com.example.eye.Const.ItemViewType.Companion.TEXT_CARD_HEADER7
import com.example.eye.Const.ItemViewType.Companion.TEXT_CARD_HEADER8
import com.example.eye.Const.ItemViewType.Companion.TOPIC_BRIEFCARD
import com.example.eye.Const.ItemViewType.Companion.UGC_SELECTED_CARD_COLLECTION
import com.example.eye.Const.ItemViewType.Companion.UNKNOWN
import com.example.eye.Const.ItemViewType.Companion.VIDEO_SMALL_CARD
import com.example.eye.R
import com.example.eye.extension.inflate
import com.example.eye.logic.model.*
import com.example.eye.ui.home.discovery.DiscoveryAdapter
 ...
 *
 * @Description:项目通用ViewHolder，集中统一管理。
 *
 */
...
class HorizontalScrollCardViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    val bannerViewPager:Banner<Discovery.ItemX,DiscoveryAdapter.HorizontalScrollCardAdapter> =view.findViewById(R.id.bannerViewPager)
}
...
class UgcSelectedCardCollectionViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val ivCoverRightTop: ImageView = view.findViewById<ImageView>(R.id.ivCoverRightTop)
...
object RecyclerViewHelp {
    ...
    fun getViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            TEXT_CARD_HEADER4 -> TextCardViewHeader4ViewHolder(R.layout.item_text_card_type_header_four.inflate(
                parent))

            TEXT_CARD_HEADER5 -> TextCardViewHeader5ViewHolder(R.layout.item_text_card_type_header_five.inflate(
                parent))

            TEXT_CARD_HEADER7 -> TextCardViewHeader7ViewHolder(R.layout.item_text_card_type_header_seven.inflate(
                parent))

            TEXT_CARD_HEADER8 -> TextCardViewHeader8ViewHolder(R.layout.item_text_card_type_header_eight.inflate(
                parent))

            TEXT_CARD_FOOTER2 -> TextCardViewFooter2ViewHolder(R.layout.item_text_card_type_footer_two.inflate(
                parent))

            TEXT_CARD_FOOTER3 -> TextCardViewFooter3ViewHolder(R.layout.item_text_card_type_footer_three.inflate(
                parent))

            HORIZONTAL_SCROLL_CARD -> HorizontalScrollCardViewHolder(R.layout.item_horizontal_scroll_card_type.inflate(
                parent))

            SPECIAL_SQUARE_CARD_COLLECTION -> SpecialSquareCardCollectionViewHolder(R.layout.item_special_square_card_collection_type.inflate(
                parent))

            COLUMN_CARD_LIST -> ColumnCardListViewHolder(R.layout.item_column_card_list_type.inflate(
                parent))
            ...
            VIDEO_SMALL_CARD -> VideoSmallCardViewHolder(R.layout.item_video_small_card_type.inflate(
                parent))

            TAG_BRIEFCARD -> TagBriefCardViewHolder(R.layout.item_brief_card_tag_brief_card_type.inflate(
                parent))

            TOPIC_BRIEFCARD -> TopicBriefCardViewHolder(R.layout.item_brief_card_topic_brief_card_type.inflate(
                parent))

            FOLLOW_CARD -> FollowCardViewHolder(R.layout.item_follow_card_type.inflate(parent))

            INFORMATION_CARD -> InformationCardFollowCardViewHolder(R.layout.item_information_card_type.inflate(
                parent))

            UGC_SELECTED_CARD_COLLECTION -> UgcSelectedCardCollectionViewHolder(R.layout.item_ugc_selected_card_collection_type.inflate(
                parent))

            AUTO_PLAY_VIDEO_AD -> AutoPlayVideoAdViewHolder(R.layout.item_auto_play_video_ad.inflate(
                parent))
