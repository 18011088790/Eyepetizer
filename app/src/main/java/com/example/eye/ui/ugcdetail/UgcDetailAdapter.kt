...
import com.example.eye.ui.community.commend.CommendAdapter
...
class UgcDetailAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        CommendAdapter.FOLLOW_CARD_TYPE -> FollowCardViewHolder(R.layout.item_ugc_detail.inflate(
            parent))
        ...
        when (holder) {
            is FollowCardViewHolder -> {
                ...
                holder.run {
                    ...
                    setOnClickListener(tvPrivateLetter,
                        tvFollow,
                        ivCollectionCount,
                        tvCollectionCount,
                        ivReply,
                        ...
                        ivShare) {
                        when (this) {
                            tvPrivateLetter, tvFollow, ivCollectionCount, tvCollectionCount, ivFavorites, tvFavorites -> start<LoginActivity>(
                                activity)
                        ...
                        item.data.content.data.urls?.run {
                            ...
                            if (item.data.content.data.urls.size > 1) {
                                ...
                                holder.tvPhotoCount.text =
                                    String.format(GlobalUtil.getString(R.string.photo_count),
                                        1,
    ...
    inner class PhotosAdapter(val dataList: List<String>, val ugcHolder: FollowCardViewHolder) :
        ...
        inner class ViewHolder(view: AppCompatImageView) : RecyclerView.ViewHolder(view) {
            val photoView = view
        }

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val photoView = AppCompatImageView(parent.context)
