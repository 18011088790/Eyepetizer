...
class FollowAdapter(val fragment: FollowFragment, var dataList: List<Follow.Item>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        Const.ItemViewType.CUSTOM_HEADER -> HeaderViewHolder(R.layout.item_community_follow_header_type.inflate(
            parent))
        AUTO_PLAY_FOLLOW_CARD -> AutoPlayFollowCardViewHolder(R.layout.item_community_auto_play_follow_card_follow_card_type.inflate(
            parent))
        ...
        when (holder) {
            ...
            is AutoPlayFollowCardViewHolder -> {
                ...
                item.data.content.data.run {
                    ...
                    holder.tvReleaseTime.text =
                        DateUtil.getDate(releaseTime ?: author?.latestReleaseTime
                    ...
                    holder.let {
                        setOnClickListener(it.videoPlayer.thumbImageView,
                            it.itemView,
