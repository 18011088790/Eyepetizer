...
import com.example.eye.ui.common.callback.RequestLifecycle
...
//        MobclickAgent.onPageEnd(javaClass.name)
    ...
    protected fun showDialogShare(shareContent: String) {
        if (this.activity is AppCompatActivity) {
            com.example.eye.extension.showDialogShare(this.activity as AppCompatActivity, shareContent)
        }
    }
}